...
import com.tradingbot.ProjectXRealtimeManager;

import io.javalin.Javalin;
import java.util.function.Function;

public final class FuturesLiveRoutes {
    private FuturesLiveRoutes() {
    }

    public static void register(Javalin app, String defaultPortfolioSymbols) {
