...
public class Orb2MissedRetestBranchRunner {
	...
	private static class Variant {
		...
		private Variant(String name, double breakVolumeRatio, double retestVolumeRatio, double maxExtensionPct, int minBarsAfterBreak) {
			this.name = name;
	...
	private static final Variant[] VARIANTS = new Variant[] {
		new Variant("current_v100_r100_ext035_b2", 1.00, 1.00, 0.35, 2),
		new Variant("break095_r100_ext035_b2", 0.95, 1.00, 0.35, 2),
		new Variant("break090_r100_ext035_b2", 0.90, 1.00, 0.35, 2),
		new Variant("break085_r100_ext035_b2", 0.85, 1.00, 0.35, 2),
		new Variant("break085_r115_ext035_b2", 0.85, 1.15, 0.35, 2),
		new Variant("break085_r125_ext035_b2", 0.85, 1.25, 0.35, 2),
		new Variant("break090_r100_ext025_b2", 0.90, 1.00, 0.25, 2),
		new Variant("break090_r100_ext035_b3", 0.90, 1.00, 0.35, 3),
		new Variant("current_faster_b1", 1.00, 1.00, 0.35, 1)
	};
	...
	public static void main(String[] args) throws Exception {
		...
		Path analysisDb = outputDir.resolve("orb2-missed-retest-branch-" + RUN_TAG + ".db");
	...
	private static void applyVariant(Variant variant) throws Exception {
